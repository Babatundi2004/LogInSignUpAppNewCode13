...
public class AddRestActivity extends AppCompatActivity {
    ...
    private void connectComponents() {
        ...
        etAddress = findViewById(R.id.etAdressAddRest);
        ...
        spCat.setAdapter(new ArrayAdapter<RestCategory>(this, android.R.layout.simple_list_item_1, RestCategory.values()));
    }
    ...
    public void add(View view) {
        ...
        Restaurant rest = new Restaurant(name, description, address, RestCategory.valueOf(category), photo, phone);
